                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="footer-one__top-wrapper">
                                <div class="footer-one__bg"><img :src="`${publicPath}assets/images/backgrounds/footer-one-bg.png`"alt=""></div>
                                <div class="row">
                                    <!--Start Footer Widget Column-->
                                    <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                                        <div class="footer-widget__column footer-widget__about">
                                            <div class="footer-widget__about-logo">
                                                <a href="index-main.html"><img :src="`${publicPath}assets/images/resources/footer-logo.png`"alt=""></a>
                                            </div>
                                            ...
                                            <div class="footer-widget__about-contact-box">
                                                <p class="phone"><a href="tel:123456789"><i class="fas fa-phone-square-alt"></i>+94 75757555</a></p>
                                                <p><a href="mailto:needhelp@company.com"><i class="fa fa-envelope"></i>AOI</a></p>
                                                <p class="text"><i class="fas fa-map-marker-alt"></i>srilanka</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="footer-widget__news-list">
                                                <li class="footer-widget__news-list-item">
                                                    <div class="footer-widget__news-list-item-img">
                                                        <img :src="`${publicPath}assets/images/resources/footer-widget-news-img1.png`"alt="">
                                                    </div>
                                                ...
                                                <li class="footer-widget__news-list-item">
                                                    <div class="footer-widget__news-list-item-img">
                                                        <img :src="`${publicPath}assets/images/resources/footer-widget-news-img2.png`"alt="">
                                                    </div>
                                                    <div class="footer-widget__news-list-item-title">
                                                        <p>20 Jul, 2021</p>
                                                        <h5><a href="#">A Clean Water Gives More<br> Good Taste</a></h5>
                                    ...
                                    <div class="col-xl-2 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.5s">
                                        <div class="footer-widget__column footer-widget__explore">
                                            ...
                                            <ul class="footer-widget__explore-list">
                                                <li class="footer-widget__explore-list-item"><a href="#">New
                                                        Projects</a></li>
                                                <li class="footer-widget__explore-list-item"><a href="#">Our
                                                        Services</a></li>
                                                <li class="footer-widget__explore-list-item"><a href="#">About
                                                        Us</a></li>
                        ...
                        <div class="col-xl-12">
                            <div class="footer-one__bottom-inner">
                                <div class="footer-one__bottom-text">
                                    <p>&copy; Copyright 2021 by <a href="#">AOI</a></p>
                                </div>
